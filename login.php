...
<?php
	...
	if(isset($_POST['login_btn']))
	{
		...
		{
			$checkusenamepass = "select * from customer_information where 
							username = '$username' and password = '$password'";
			$data = select_one($checkusenamepass);
			$sqlcheckad = "select * from staff where
					 username_sa = '$username' and password_sa = '$password'";
...
<head>
	...
	<link rel="icon" type="images/png" href="img/watch.jpg">  
