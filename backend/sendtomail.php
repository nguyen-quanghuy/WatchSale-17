        ...
        <div style="width: 100%;height: 80px;border-bottom: 1px solid gray;">
            ...
            <div>
                <div style="width: 80% ; margin: auto;height: 419px;">
                    ...
                    <span style="padding: 10px;color: #fff; animation: moveInRight 1s ease-out;">Chào mừng bạn đến với Group_17 shop bán hàng uy tín nổi trội cảm ơn bạn đã sử dụng dịch vụ của chúng tôi mã của bạn là :</span>
